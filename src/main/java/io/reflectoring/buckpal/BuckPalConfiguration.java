...
public class BuckPalConfiguration {
  ...
  /**
   * Adds a use-case-specific {@link MoneyTransferProperties} object to the application context. The
   * properties are read from the Spring-Boot-specific {@link BuckPalConfigurationProperties}
   * object.
   */
  @Bean
